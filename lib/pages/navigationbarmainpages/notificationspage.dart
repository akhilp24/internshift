...
class NotificationsPage extends StatefulWidget {
  ...
  NotificationsPage({this.username});
  @override
          ...
          Padding(
            ...
            child: Center(
              child: Stack(alignment: Alignment.topCenter, children: [
                Container(
                  child: ListOfNotifications(username: widget.username),
...
class ListOfNotifications extends StatefulWidget {
  final String username;
  ListOfNotifications({this.username});
  @override
                ...
                return Dismissible(
                  ...
                  onDismissed: (direction) async {
                    await Firestore.instance
                      ...
                      await myTransaction
                          .delete(snapshot.data.documents[i].reference);
                    });
                    Scaffold.of(context)
